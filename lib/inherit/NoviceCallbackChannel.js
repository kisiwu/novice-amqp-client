...
// inherit
function NoviceAMQPCallbackChannel(connection, defaultHeaders){
    Channel.call(this, connection);
    this.defaultHeaders = defaultHeaders && typeof defaultHeaders === 'object' ? defaultHeaders : {};
}
inherits(NoviceAMQPCallbackChannel, Channel)
NoviceAMQPCallbackChannel.prototype.publish = function(exchange, routingKey, content, options) {
    var self = this;
...
exports = module.exports = NoviceAMQPCallbackChannel;